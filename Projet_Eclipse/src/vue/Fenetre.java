...
public class Fenetre extends JFrame {
		...
		protected static final String CALCULER_TOURNEE = "Calculer la tourn�e";
		protected static final String GENERER_FEUILLE_ROUTE = "G�n�rer la feuille de route";
		 ...
		 * un cadre pour afficher des informations compl�mentaires, une zone textuelle decrivant
		 * la demande de livraison ou la tourn�e et un ecouteur de boutons qui envoie des messages au controleur.
		 * @param plan le plan
		...
		public Fenetre(Plan plan, DemandeLivraison demandeLivraison, int echelle, Controleur controleur){
			...
			cadreMessages.setBorder(BorderFactory.createTitledBorder("Infos compl�mentaires"));
